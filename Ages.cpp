...
void Age::initAnimationsRects()
{
		//WARRIOR
		//Stay
		sf::IntRect stay1 = sf::IntRect(12, 175, 65, 55);
		sf::IntRect stay2 = sf::IntRect(162, 175, 65, 55);
		sf::IntRect stay3 = sf::IntRect(312, 175, 65, 55);
		sf::IntRect stay4 = sf::IntRect(462, 175, 65, 55);
		sf::IntRect stay5 = sf::IntRect(612, 175, 65, 55);
		sf::IntRect stay6 = sf::IntRect(762, 175, 65, 55);
		...
		//Run
		sf::IntRect run1 = sf::IntRect(6, 306, 65, 55);
		sf::IntRect run2 = sf::IntRect(160, 306, 65, 55);
		sf::IntRect run3 = sf::IntRect(314, 306, 65, 55);
		sf::IntRect run4 = sf::IntRect(458, 308, 65, 55);
		sf::IntRect run5 = sf::IntRect(606, 300, 65, 55);
		sf::IntRect run6 = sf::IntRect(759, 306, 65, 55);
		...
		//Attack
		sf::IntRect atk1 = sf::IntRect(99, 80, 65, 55);
		sf::IntRect atk2 = sf::IntRect(252, 80, 65, 55);
		sf::IntRect atk3 = sf::IntRect(430, 80, 65, 55);
		sf::IntRect atk4 = sf::IntRect(580, 80, 65, 55);
		...
		//Death
		sf::IntRect dead1 = sf::IntRect(12, 430, 65, 55);
		sf::IntRect dead2 = sf::IntRect(157, 430, 65, 55);
		sf::IntRect dead3 = sf::IntRect(305, 430, 65, 55);
		sf::IntRect dead4 = sf::IntRect(440, 430, 65, 55);
		sf::IntRect dead5 = sf::IntRect(588, 430, 65, 55);
		sf::IntRect dead6 = sf::IntRect(734, 430, 65, 55);
